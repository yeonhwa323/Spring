		...
		<div id="join-form" class="join-form margin-large">
			<dl class="join-form-row">
				...
				<dd class="join-form-data">
					<input type="text" name="id" value="yeon" /> <input
			...
			<dl class="join-form-row birthday">
				...
				<dd class="join-form-data">
					<span> <input type="text" id="year" value="1989" />년 <input
						...
						value="23" />일 <input type="hidden" name="birth" id="birth" /> <script>
                                         $("#day").blur(function (){
                                            var year = $("#year").val();
                                            var month = $("#month").val();
                                            var day = $("#day").val();
			...
			<dl class="join-form-row">
				...
				<dd class="join-form-data habit">
					<input type="checkbox" name="habit" id="music" value="music"
						...
						type="checkbox" name="habit" id="movie" value="movie" /><label
						for="movie">영화</label> <input type="checkbox" name="habit"
						id="trip" value="trip" checked="checked" /><label for="trip">여행</label>
				</dd>
			</dl>
		</div>
		<div id="buttonLine">
