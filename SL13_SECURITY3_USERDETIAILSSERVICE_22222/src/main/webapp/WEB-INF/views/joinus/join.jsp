						...
						<div id="join-form" class="join-form margin-large" >						
							<dl class="join-form-row">
								...
								<dd class="join-form-data">
									<input type="text" name="id" value="malgeum" />
							...
							<dl class="join-form-row birthday">
								...
								<dd class="join-form-data">								
	                                <span>
	                                    <input type="text" id="year" value="1989"/>년
	                                    <input type="text" id="month" value="11"/>월
							...
							<dl class="join-form-row">
								...
								<dd class="join-form-data">
									<input type="text" name="email" value="malgeum@naver.com"/>
								</dd>
							</dl>
							<dl class="join-form-row">
								<dt class="join-form-title">
