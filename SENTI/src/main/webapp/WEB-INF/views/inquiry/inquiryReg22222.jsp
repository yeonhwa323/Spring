			...
			<div class="article_right">
				...
				<section class="my_inq">
					...
					<form
						...
						<div class="tb_lst">
							...
							<li>
								...
								<div class="in_td">
									...
									<input type="radio" id="쿠폰/마일리지문의" name="generalInquiry"
										value="6"> <label for="쿠폰/마일리지문의"
										style="padding-left: 25px;">쿠폰/마일리지문의</label><br>
								</div>
							</li>
							<li>
						...
						<a class="btn_bx" href="/inquiry/inquiry.do">취소</a>
...
<script>
/*         document.addEventListener("DOMContentLoaded", function() {
            const radioButtons = document.querySelectorAll('input[name="inquiry"]');
